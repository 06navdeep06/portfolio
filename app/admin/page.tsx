...
export default function AdminDashboard() {
  ...
  // This is a fallback - the layout should handle this
  if (!user) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="mt-2 max-w-xl text-sm text-gray-500">
                <p>This is your admin dashboard where you can manage your portfolio content.</p>
              </div>
              <div className="mt-5">
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-blue-700">
                        <p>
                          You have full administrative access to manage all aspects of your portfolio.
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="grid grid-cols-1 gap-5 mt-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-4 py-4 sm:px-6">
              <div className="text-sm">
                <a href="/admin/projects" className="font-medium text-blue-600 hover:text-blue-500">
                  View all
                </a>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-4 py-4 sm:px-6">
              <div className="text-sm">
                <a href="/admin/messages" className="font-medium text-blue-600 hover:text-blue-500">
                  View all messages
                </a>
              </div>
            </div>
